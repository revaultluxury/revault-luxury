...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\PaymentGateway\PaymentGateway' => \App\PaymentGateway\IpaymuImpl::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\Kerja\freelance\revault-luxury\public\storage' => 'string',
            ...
            'services.ipaymu.va' => 'string',
            'services.ipaymu.api_key' => 'string',
            'services.ipaymu.base_url' => 'string',
...
'app.aliases.Vite','app.seed_key','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\Kerja\\freelance\\revault-luxury\\public\\storage','inertia.ssr.enabled',
...
'services.ipaymu.va','services.ipaymu.api_key','services.ipaymu.base_url','session.driver','session.lifetime',
...
'web','api',);
        registerArgumentsSet('routes', 'index','about-us','products.cart','products.checkout.create',
'products.checkout.cart','products.checkout','products.checkout.session','products.per-category','products.show',
'admin.index','admin.index.post','admin.seed','admin.dashboard','admin.transactions',
'admin.products','admin.products.create','admin.products.edit','admin.products.store','admin.products.update',
'admin.products.destroy','admin.codes','admin.codes.store','admin.logout','storage.local',);
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','content.title',
'php_en.0',);
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','IPAYMU_VA',
'IPAYMU_API_KEY','IPAYMU_BASE_URL','APP_SEED_KEY',);
